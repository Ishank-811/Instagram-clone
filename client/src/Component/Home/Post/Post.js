      ...
      <div className="full-post">
        <div className="post">
          <div className="post-head">
            ...
            {name === props.post.creator && (
              <button
                onClick={() => dispatch(deleteposts(props.post._id))}
                className="user-action deletebutton"
              >
                Delete
              </button>
            )}
          ...
          <div className="post-actions">
            {!liked ? (
              <i
                ...
                onClick={() => {
                  dispatch(likeposts(props.post._id));
                }}
              ...
              <i
                ...
                onClick={() => {
                  dispatch(unlikeposts(props.post._id));
                }}
          ...
          <div className="viewcomments">
            <a className="allcomment" href=" ">
              View all <span>{props?.post?.comments?.length}</span> comments
            </a>
          </div>
