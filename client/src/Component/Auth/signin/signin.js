          ...
          <h1 style={{color:"red" , fontWeight:"500"}}> {error}</h1> : " " 
                 ...
                 <div className="form-wrap">
                  <form onSubmit={handleSubmit} className="form">
                    ...
                    <div className="input-box">
                      <input name="email" type="text" id="name"  onChange={handleChange}   
                      placeholder="Phone number, username, or email" aria-required="true" maxLength="30" autoCapitalize="off" rect="off" required></input>
                    </div>  
            ...
            ></Input>
                    ...
                    <GoogleLogin 
                        ...
                        render={(renderprops) => (
                            <Button
                            style={{width:"200px" , margin:"auto"  ,height:"30px"}}
                    ...
                    <a className="forgot" href="/signup">Forgot password?</a>
                  </form>
                </div> 
              </div> 
              ...
              <div className="app">
                ...
                <div className="app-img">
                  <a href="https://itunes.apple.com/app/instagram/id389801252?pt=428156&amp;ct=igweb.loginPage.badge&amp;mt=8">
                    <img alt="ios" src="https://www.instagram.com/static/images/appstore-install-badges/badge_ios_english-en.png/4b70f6fae447.png" ></img>
                  </a>
                  <a href="https://play.google.com/store/apps/details?id=com.instagram.android&amp;referrer=utm_source%3Dinstagramweb%26utm_campaign%3DloginPage%26utm_medium%3Dbadge">
                    <img alt="android" src="https://www.instagram.com/static/images/appstore-install-badges/badge_android_english-en.png/f06b908907d5.png"></img>
                  </a>  
                </div>  
              </div>
            </div> 
